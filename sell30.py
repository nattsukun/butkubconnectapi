...
print(bitkub.place_ask(sym=df['unit'][20], amt=df['y'][20], rat=df['x'][20], typ='limit'))   #SELL
print(bitkub.place_ask(sym=df['unit'][21], amt=df['y'][21], rat=df['x'][21], typ='limit'))   #SELL
print(bitkub.place_ask(sym=df['unit'][22], amt=df['y'][22], rat=df['x'][22], typ='limit'))   #SELL
print(bitkub.place_ask(sym=df['unit'][23], amt=df['y'][23], rat=df['x'][23], typ='limit'))   #SELL
print(bitkub.place_ask(sym=df['unit'][24], amt=df['y'][24], rat=df['x'][24], typ='limit'))   #SELL
print(bitkub.place_ask(sym=df['unit'][25], amt=df['y'][25], rat=df['x'][25], typ='limit'))   #SELL
print(bitkub.place_ask(sym=df['unit'][27], amt=df['y'][26], rat=df['x'][26], typ='limit'))   #SELL
print(bitkub.place_ask(sym=df['unit'][28], amt=df['y'][27], rat=df['x'][27], typ='limit'))   #SELL
print(bitkub.place_ask(sym=df['unit'][29], amt=df['y'][28], rat=df['x'][28], typ='limit'))   #SELL
print(bitkub.place_ask(sym=df['unit'][29], amt=df['y'][29], rat=df['x'][29], typ='limit'))   #SELL
